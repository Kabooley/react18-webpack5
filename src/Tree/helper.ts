...
// TODO: destinationIdのexplorerはgetParentNodeByChildIdで取得しようとすると、
// その親explorerを取得してしまうのでこれの修正: `getNodeById`の生成
export const pushIntoExplorer = (explorer: iExplorer, toBePushed: iExplorer, destinationId: string): void => {
console.log("[pushIntoExplorer]");
...
// (function() {
//   const toBeMovedId = "4";
//   const toBeMovedItem = retrieveFromExplorer(explorer, toBeMovedId);
//   console.log(toBeMovedItem);
//   toBeMovedItem && pushIntoExplorer(explorer, toBeMovedItem, "7");
